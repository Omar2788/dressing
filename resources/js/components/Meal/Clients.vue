<template>
  <div class="row">
    <Sidebar />
    <hr>
    <h2>Tableau de Clients</h2>
    <AjouterClient/>
   
    <DataTable v-model:filters="filters" :value="articles" :loading="isLoading" paginator rows="10" :rowsPerPageOptions="[10, 20, 50,100,200]">
      <template #header>
      ...
      <Column field="nom" header="Nom de client" sortable :filter="true"></Column>
      <Column field="prenom" header="Prénom de client" sortable :filter="true"></Column>
      ...
      <Column field="created_at" header="Date d'ajout" sortable :filter="true" :body="formatDate"></Column>
...
import AjouterClient from '../Meal/AjouterClient.vue';
